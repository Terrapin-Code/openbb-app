...
def document_selector_param() -> dict[str, Any]:
    return _param(
        ...
        type="endpoint",
        label="Documents",
        description="Official statements and disclosures for the selected CUSIP",
        show=True,
        multiSelect=True,
        roles=["fileSelector"],
...
WIDGETS: dict[str, dict[str, Any]] = {
    ...
    "muni_bond_search": {
        "name": "Bond Explorer",
        "description": "Search and filter US municipal bonds with an official statement. Click a CUSIP to load the bond in Security Details.",
        "type": "table",
